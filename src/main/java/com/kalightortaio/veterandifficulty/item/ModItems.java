...
public class ModItems {
    ...
    public static final Item ACACIA_POD = registerItem("acacia_pod", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.ACACIA_POD)));
    public static final Item BAMBOO_SHOOT = registerItem("bamboo_shoot", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.BAMBOO_SHOOT)));
    public static final Item BIRCH_BARK = registerItem("birch_bark", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.BIRCH_BARK)));
    public static final Item CACTUS_FRUIT = registerItem("cactus_fruit", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.CACTUS_FRUIT)));
    public static final Item CALAMARI = registerItem("calamari", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.CALAMARI)));
    public static final Item CHERRY = registerItem("cherry", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.CHERRY)));
    public static final Item COOKED_EGG = registerItem("cooked_egg", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.COOKED_EGG)));
    public static final Item CREEPER_POD = registerItem("creeper_pod", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.CREEPER_POD)));
    public static final Item CRIMSON_ROOT = registerItem("crimson_root", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.CRIMSON_ROOT)));
    public static final Item GLOWING_CALAMARI = registerItem("glowing_calamari", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.GLOWING_CALAMARI)));
    public static final Item LICHEN_CLUMP = registerItem("lichen_clump", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.LICHEN_CLUMP)));
    public static final Item MANGO = registerItem("mango", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.MANGO)));
    public static final Item MOSS_CLUMP = registerItem("moss_clump", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.MOSS_CLUMP)));
    public static final Item PUMPKIN_SLICE = registerItem("pumpkin_slice", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.PUMPKIN_SLICE)));
    public static final Item RIPE_SPROUT = registerItem("ripe_sprout", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.RIPE_SPROUT)));
    public static final Item RIPE_SUGAR_CANE = registerItem("ripe_sugar_cane", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.RIPE_SUGAR_CANE)));
    public static final Item RIPE_WART = registerItem("ripe_wart", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.RIPE_WART)));
    public static final Item SCULK_GROWTH = registerItem("sculk_growth", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.SCULK_GROWTH)));
    public static final Item SOUR_CHERRY = registerItem("sour_cherry", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.SOUR_CHERRY)));
    public static final Item SPRUCE_CONE = registerItem("spruce_cone", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.SPRUCE_CONE)));
    public static final Item TELEPORTED_MORSEL = registerItem("teleported_morsel", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.TELEPORTED_MORSEL)));
    public static final Item WARPED_ROOT = registerItem("warped_root", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.WARPED_ROOT)));
    public static final Item WILD_RICE = registerItem("wild_rice", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.WILD_RICE)));
    public static final Item WILD_ROOT = registerItem("wild_root", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.WILD_ROOT)));
    public static final Item WORM = registerItem("worm", ItemGroups.FOOD_AND_DRINK, Items.PUMPKIN_PIE, new Item(new FabricItemSettings().food(ModFoods.WORM)));
